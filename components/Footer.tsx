...
const Footer: React.FC<FooterProps> = ({ isDarkMode }) => {
  return (
    <div className="mt-20">
      ...
      <div className="bg-opacity-50 backdrop-blur-lg shadow-sm px-6 sm:px-12 2xl:px-0">
        <div className="max-w-[100rem] mx-auto text-center sm:flex items-center justify-between py-6">
